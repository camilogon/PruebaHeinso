...
namespace PruebaHeinson.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(PruebaHeinsonContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != orderDetail.idOrderDatails)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
            ...
            return CreatedAtAction("GetOrderDetail", new { id = orderDetail.idOrderDatails }, orderDetail);
        }
        ...
        {
            return _context.OrderDetail.Any(e => e.idOrderDatails == id);
        }
    }
}
